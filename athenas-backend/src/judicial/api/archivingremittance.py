...
from judicial.models import ArchivingRemittance


log = getLogger(__name__)


class EJudArchivingRemittance(BasePartLawsuit, Restful):

    _model = ArchivingRemittance

    def get_params(self, *args, **kargs):
        params = super(EJudArchivingRemittance, self).get_params(*args, **kargs)
    ...
    def complement_model_to_dict(self, instance):
        rst = super(EJudArchivingRemittance, self).complement_model_to_dict(instance)

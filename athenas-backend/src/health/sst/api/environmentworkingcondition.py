...
from health.sst.models import EnvironmentWorkingCondition


log = getLogger(__name__)


class SSTEnvironmentWorkingCondition(RestfulDRY):

    _model = EnvironmentWorkingCondition
    ...
    def json(self, args=[]):
        ...
        self.response.write(
            'Ext._create("health.sst.EnvironmentWorkingConditionManage")'
        )


class SSTWorkingConditionHarmfulAgentManage(SSTEnvironmentWorkingCondition):
    ...
    def json(self, args=[]):
        self.response["content-type"] = "text/javascript"
        self.response.write(
            'Ext._create("health.sst.WorkingConditionHarmfulAgentManage")'
        )


class SSTWorkingConditionExposureEmployeeManage(SSTEnvironmentWorkingCondition):
    ...
    def json(self, args=[]):
        self.response["content-type"] = "text/javascript"
        self.response.write(
            'Ext._create("health.sst.WorkingConditionExposureEmployeeManage")'
        )

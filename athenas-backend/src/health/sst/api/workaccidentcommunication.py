...
class SSTWorkAccidentCommunication(RestfulDRY):

    _model = WorkAccidentCommunication
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("health.sst.WorkAccidentCommunicationManage")')

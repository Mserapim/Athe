...
from health.sst.models import EnvironmentHarmfulAgent


log = getLogger(__name__)


class SSTEnvironmentHarmfulAgent(RestfulDRY):

    _model = EnvironmentHarmfulAgent
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("health.sst.EnvironmentHarmfulAgentManage")')

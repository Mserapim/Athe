...
from health.sst.models import CauserAgentAccident


log = getLogger(__name__)


class SSTCauserAgentAccident(RestfulDRY):

    _model = CauserAgentAccident
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("health.sst.CauserAgentAccidentManage")')

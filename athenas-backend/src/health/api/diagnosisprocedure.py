...
from health.models import DiagnosisProcedure


log = getLogger(__name__)


class HEALTHDiagnosisProcedure(RestfulDRY):

    _model = DiagnosisProcedure
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("health.DiagnosisProcedureManage")')

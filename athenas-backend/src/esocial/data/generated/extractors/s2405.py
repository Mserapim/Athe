...
class S2405Extractor(Extractor):

    def __init__(self, *args, **kwargs):
        self.clear = kwargs.get("clear", False)
        super(S2405Extractor, self).__init__(*args, **kwargs)
    ...
    def dados_benef_nm_benefic(self):
        return ""

    def dados_benef_sexo(self):
        return ""

    def dados_benef_raca_cor(self):
        return ""

    def dados_benef_est_civ(self):
        return ""

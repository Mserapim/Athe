...
class S1202(Register):
    class Meta:
        app_label = "esocial"

    XML_SCHEMA_NAME = "evtRmnRPPS.xsd"
    XMLNS = "http://www.esocial.gov.br/schema/evt/evtRmnRPPS/v_S_01_02_00"
    GROUP = 3
    ...
    info_per_ant_remun_org_suc = models.CharField(max_length=1, null=True, blank=True)

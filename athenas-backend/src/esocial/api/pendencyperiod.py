...
from esocial.models import PendencyPeriod


log = getLogger(__name__)


class ESOCIALPendencyPeriod(RestfulDRY):

    _model = PendencyPeriod
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("esocial.PendencyPeriodManage")')

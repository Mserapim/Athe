...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "county",
                    self.gf("django.db.models.fields.related.OneToOneField")(
                        related_name="county_marker", unique=True, to=orm["rh.Comarca"]
                    ),
                ),
            ),
        )
        db.send_create_signal("web", ["CountyMarker"])

        # Adding model 'ProsecutorActionStatus'
        db.create_table(
            "web_prosecutoractionstatus",
            (
                (
                    "common_ptr",
                    self.gf("django.db.models.fields.related.OneToOneField")(
        ...
        db.send_create_signal("web", ["ProsecutorActionStatus"])
        ...
        db.send_create_signal("web", ["Module"])
        ...
        db.send_create_signal("web", ["Common"])
        ...
        db.send_create_signal("web", ["Map"])

        # Adding M2M table for field markers on 'Map'
        db.create_table(
            "web_map_markers",
            (
                (
                ...
                ("map", models.ForeignKey(orm["web.map"], null=False)),
                ("mapmarker", models.ForeignKey(orm["web.mapmarker"], null=False)),
            ),
        )
        db.create_unique("web_map_markers", ["map_id", "mapmarker_id"])
        ...
        db.create_table(
            ...
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                ("latitute", self.gf("django.db.models.fields.FloatField")()),
                ("longitude", self.gf("django.db.models.fields.FloatField")()),
            ),
        )
        db.send_create_signal("web", ["MapMarker"])

        # Adding model 'ProsecutorAction'
        db.create_table(
            ...
            (
                ...
                (
                    "start_date",
                    self.gf("django.db.models.fields.DateField")(db_index=True),
                ),
        ...
        db.send_create_signal("web", ["ProsecutorAction"])

        # Adding M2M table for field modules on 'Area'
        db.create_table(
            "web_area_modules",
            (
                (
                ...
                ("area", models.ForeignKey(orm["web.area"], null=False)),
                ("module", models.ForeignKey(orm["web.module"], null=False)),
            ),
        )
        db.create_unique("web_area_modules", ["area_id", "module_id"])

        # Deleting field 'Content.abstract'
        db.delete_column("web_content", "abstract")
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CountyMarker'
        db.delete_table("web_countymarker")

        # Deleting model 'ProsecutorActionStatus'
        db.delete_table("web_prosecutoractionstatus")

        # Deleting model 'Module'
        db.delete_table("web_module")

        # Deleting model 'Common'
        db.delete_table("web_common")

        # Deleting model 'Map'
        db.delete_table("web_map")

        # Removing M2M table for field markers on 'Map'
        db.delete_table("web_map_markers")

        # Deleting model 'MapMarker'
        db.delete_table("web_mapmarker")

        # Deleting model 'ProsecutorAction'
        db.delete_table("web_prosecutoraction")

        # Removing M2M table for field modules on 'Area'
        db.delete_table("web_area_modules")

        # Adding field 'Content.abstract'
        db.add_column(
            "web_content",
            "abstract",
    ...
    models = {
        ...
        "web.area": {
            ...
            "kind_of_content": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'area'", "max_length": "10", "null": "True"},
            ),
            "modules": (
                "django.db.models.fields.related.ManyToManyField",
                [],
        ...
        "web.prosecutoraction": {
            "Meta": {"object_name": "ProsecutorAction", "_ormbases": ["web.Content"]},

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal("web", ["WebUser"])

        # Adding model 'TokenWebUser'
        db.create_table(
            "web_tokenwebuser",
            (
                (
        ...
        db.send_create_signal("web", ["TokenWebUser"])

        # Adding model 'RegularWebUser'
        db.create_table(
            "web_regularwebuser",
            (
                (
                ...
                (
                    "person",
                    self.gf("django.db.models.fields.related.OneToOneField")(
                        related_name="web_user", unique=True, to=orm["rh.Pessoa"]
                    ),
                ),
            ),
        )
        db.send_create_signal("web", ["RegularWebUser"])

    def backwards(self, orm):
        # Deleting model 'WebUser'
        db.delete_table("web_webuser")

        # Deleting model 'TokenWebUser'
        db.delete_table("web_tokenwebuser")

        # Deleting model 'RegularWebUser'
        db.delete_table("web_regularwebuser")

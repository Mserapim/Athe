...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProsecutorAction.abstract'
        db.delete_column("web_prosecutoraction", "abstract")

        # Deleting field 'ProsecutorAction.content_ptr'
        db.delete_column("web_prosecutoraction", "content_ptr_id")

        # Adding field 'ProsecutorAction.post_ptr'
        db.add_column(
            "web_prosecutoraction",
            "post_ptr",
            self.gf("django.db.models.fields.related.OneToOneField")(
                default=None, to=orm["web.Post"], unique=True, primary_key=True
            ),
            keep_default=False,
        )

    def backwards(self, orm):
        # Adding field 'ProsecutorAction.abstract'
        db.add_column(
            "web_prosecutoraction",
            "abstract",
        ...
        # Adding field 'ProsecutorAction.content_ptr'
        db.add_column(
            "web_prosecutoraction",
            "content_ptr",
            self.gf("django.db.models.fields.related.OneToOneField")(
                default=None, to=orm["web.Content"], unique=True, primary_key=True
            ),
            keep_default=False,
        )

        # Deleting field 'ProsecutorAction.post_ptr'
        db.delete_column("web_prosecutoraction", "post_ptr_id")

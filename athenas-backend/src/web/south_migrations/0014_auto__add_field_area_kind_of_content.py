...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Area.kind_of_content'
        db.add_column(
            "web_area",
            "kind_of_content",
            self.gf("django.db.models.fields.CharField")(
                default="Post", max_length=10, null=True
            ),
            keep_default=False,
        )

    def backwards(self, orm):
        # Deleting field 'Area.kind_of_content'
        db.delete_column("web_area", "kind_of_content")
    ...
    models = {
        ...
        "rh.movimentacaopessoal": {
            ...
            "servidor": (
                "django.db.models.fields.related.ForeignKey",
                [],
                {"to": "orm['rh.Servidor']", "on_delete": "models.PROTECT"},
            ),
            "texto": (
                "django.db.models.fields.TextField",
                [],

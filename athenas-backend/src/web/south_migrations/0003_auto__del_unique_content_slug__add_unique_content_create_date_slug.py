...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique("web_content", ["slug"])

        # Adding unique constraint on 'Content', fields ['create_date', 'slug']
        db.create_unique("web_content", ["create_date", "slug"])

    def backwards(self, orm):

        # Removing unique constraint on 'Content', fields ['create_date', 'slug']
        db.delete_unique("web_content", ["create_date", "slug"])

        # Adding unique constraint on 'Content', fields ['slug']
        db.create_unique("web_content", ["slug"])

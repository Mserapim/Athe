...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MapMarker.latitute'
        db.delete_column("web_mapmarker", "latitute")

        # Adding field 'MapMarker.latitude'
        db.add_column(
            "web_mapmarker",
            "latitude",
    ...
    def backwards(self, orm):
        # Adding field 'MapMarker.latitute'
        db.add_column(
            "web_mapmarker",
            "latitute",
            self.gf("django.db.models.fields.FloatField")(default=None),
        ...
        # Deleting field 'MapMarker.latitude'
        db.delete_column("web_mapmarker", "latitude")
    ...
    models = {
        ...
        "web.map": {
            ...
            "map_type_id": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'roadmap'", "max_length": "50", "null": "True"},
            ),
            "markers": (
                "django.db.models.fields.related.ManyToManyField",
                [],

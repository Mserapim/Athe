...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Multimedia.embed_temp'
        db.add_column(
            "web_multimedia",
            "embed_temp",
        ...
        for m in Multimedia.objects.filter(url_embed__isnull=False):
            m.embed_temp = m.url_embed
            print("%s ==> %s" % (m.url_embed, m.embed_temp))
            m.save()

    def backwards(self, orm):
        # Deleting field 'Multimedia.embed_temp'
        db.delete_column("web_multimedia", "embed_temp")

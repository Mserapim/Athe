...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Link.external'
        db.delete_column("web_link", "external")

        # Adding field 'Link.kind'
        db.add_column(
            "web_link",
            "kind",
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Link.kind'
        db.delete_column("web_link", "kind")

        # Deleting field 'Content.as_link'
        db.delete_column("web_content", "as_link")

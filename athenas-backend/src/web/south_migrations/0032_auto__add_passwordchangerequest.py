...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PasswordChangeRequest'
        db.create_table(
            "web_passwordchangerequest",
            (
        ...
        db.send_create_signal("web", ["PasswordChangeRequest"])

        # Adding M2M table for field user on 'PasswordChangeRequest'
        m2m_table_name = db.shorten_name("web_passwordchangerequest_user")
        db.create_table(
            m2m_table_name,
            (
                (
                ...
                (
                    ...
                    models.ForeignKey(orm["web.passwordchangerequest"], null=False),
                ),
                (
                    "regularwebuser",
                    models.ForeignKey(orm["web.regularwebuser"], null=False),
                ),
            ),
        )
        db.create_unique(
            m2m_table_name, ["passwordchangerequest_id", "regularwebuser_id"]
        )

    def backwards(self, orm):
        # Deleting model 'PasswordChangeRequest'
        db.delete_table("web_passwordchangerequest")

        # Removing M2M table for field user on 'PasswordChangeRequest'
        db.delete_table(db.shorten_name("web_passwordchangerequest_user"))
    ...
    models = {
        ...
        "web.metakey": {
            ...
            "key": (
                "django.db.models.fields.CharField",
                [],
                {"unique": "True", "max_length": "128", "db_index": "True"},
            ),
        },
        "web.metavalue": {
            ...
            "value": (
                "django.db.models.fields.CharField",
                [],
                {"unique": "True", "max_length": "384", "db_index": "True"},
            ),
        },
        "web.module": {
        ...
        "web.multimedia": {
            ...
            "url_embed": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'#'", "max_length": "400", "db_index": "True"},
            ),
        },
        "web.passwordchangerequest": {
            "Meta": {"object_name": "PasswordChangeRequest"},
            "id": ("django.db.models.fields.AutoField", [], {"primary_key": "True"}),
            "key": (
                "django.db.models.fields.CharField",
                [],
        ...
        "web.regularwebuser": {
            "Meta": {"object_name": "RegularWebUser", "_ormbases": ["web.WebUser"]},
            "email": (
                "django.db.models.fields.EmailField",
                [],
            ...
            "webuser_ptr": (
                "django.db.models.fields.related.OneToOneField",
                [],
                {"to": "orm['web.WebUser']", "unique": "True", "primary_key": "True"},
            ),
        },
        "web.tag": {
            ...
            "slug": ("django.db.models.fields.SlugField", [], {"max_length": "384"}),
        },
        "web.tokenwebuser": {
            "Meta": {"object_name": "TokenWebUser", "_ormbases": ["web.WebUser"]},
            "person": (
                "django.db.models.fields.related.OneToOneField",
                [],
                {

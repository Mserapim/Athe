...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(
            "web_tag",
            "slug",
            self.gf("django.db.models.fields.SlugField")(default="", max_length=384),
        )
        ...
        # Changing field 'Area.kind_of_content'
        db.alter_column(
            "web_area",
            "kind_of_content",
        ...
        # Changing field 'Comment.person_name'
        db.alter_column(
            "web_comment",
            "person_name",
            self.gf("django.db.models.fields.CharField")(default="", max_length=256),
        ...
        # Changing field 'MetaKey.key'
        db.alter_column(
            "web_metakey",
            "key",
            self.gf("django.db.models.fields.CharField")(
                default="", unique=True, max_length=128
            ),
        )

        # Changing field 'PollConditions.expression'
        db.alter_column(
            "web_pollconditions",
            "expression",
            self.gf("django.db.models.fields.CharField")(default="", max_length=256),
        ...
        # Changing field 'PollConditions.description'
        db.alter_column(
            "web_pollconditions",
            "description",
            self.gf("django.db.models.fields.CharField")(default="", max_length=256),
        ...
        # Changing field 'MetaValue.value'
        db.alter_column(
            "web_metavalue",
            "value",
            self.gf("django.db.models.fields.CharField")(
                default="", unique=True, max_length=384
            ),
        )

        # Changing field 'WebGroup.name'
        db.alter_column(
            "web_webgroup",
            "name",
            self.gf("django.db.models.fields.CharField")(default="", max_length=128),
        ...
        # Changing field 'Map.map_type_id'
        db.alter_column(
            "web_map",
            "map_type_id",
    ...
    def backwards(self, orm):
        ...
        db.alter_column(
            "web_tag",
            "slug",
            self.gf("django.db.models.fields.SlugField")(max_length=384, null=True),
        )
        ...
        db.alter_column(
            "web_content",
            "slug",
            self.gf("django.db.models.fields.SlugField")(max_length=256, null=True),
        )
        ...
        db.alter_column(
            ...
            "key",
            self.gf("django.db.models.fields.CharField")(
                unique=True, max_length=128, null=True
            ),
        )
        ...
        db.alter_column(
            ...
            "value",
            self.gf("django.db.models.fields.CharField")(
                unique=True, max_length=384, null=True
            ),
        )

...
class Command(BaseCommand):
    help = """Esse Comando irá disparar emails para os beneficiarios externos de viagens do diarias
    ...
    def busca_beneficiarios(self):
        ...
        return Beneficiario.objects.filter(
            servidor__type_by_possession__in=["COE", "TCR"],
            historico_fluxos__fluxo=FLUXO,
    ...
    def enviar_email_notificacao_prestacao_contas(self):
        ...
        for beneficiario in beneficiarios:
            ...
            try:
                ...
                envio_email_prestacao_contas_colaboradores_externos(beneficiario)

...
class CadastraQualityConfig(
    AppConfig
):  # Substituir "Sample" pelo nome que preferir dar ao AppConfig
    name = "rh.cadastralquality"  # Caminho completo para o app. Ex: rh.gfp.dirf
    default_auto_field = "django.db.models.BigAutoField"

    controllers = [
        # Aqui devem ser listados os caminhos dos controllers do app. Ex: web.api.cms.metadata
        "rh.cadastralquality.api.registrationquery",
        "rh.cadastralquality.api.report",
    ]
...
def register_statics():
    ...
    js_paths = (
        "/%(context)s/static/rh/cadastralquality/Manage.js",
        "/%(context)s/static/rh/cadastralquality/Grid.js",
        "/%(context)s/static/rh/cadastralquality/Restful.js",
        "/%(context)s/static/rh/cadastralquality/Window.js",
        "/%(context)s/static/rh/cadastralquality/OpenReportWindow.js",
    )

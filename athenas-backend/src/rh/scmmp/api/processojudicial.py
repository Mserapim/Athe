...
class ScmmpProcessoJudicial(Restful):

    _model = ProcessoJudicial

    force_upper = False

    full_text_index = (
        "numero_cnj__icontains",
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("scmmp.processojudicial.Manage")')
    ...
    def model_to_dict(self, instance):
        ...
        rst.update(
            ...
            numero_cnj=instance.numero_cnj,
            url=instance.url,
            ...
            tipo_processo_judicial=instance.tipo_processo_judicial,
            tipo_processo_judicial_display=nil_display(
                instance, "tipo_processo_judicial", None
            ),

...
class RhDadosBaancariosConfig(
    AppConfig
):  # Substituir "Sample" pelo nome que preferir dar ao AppConfig
    name = "rh.dados_bancarios"  # Caminho completo para o app. Ex: rh.gfp.dirf
...
def register_statics():
    ...
    for path in js_paths:
        Application.register_javascript(path, scope="dadoss_bancarios")

...
class DAYOFFActivity(RestfulDRY):
    ...
    def model_to_dict(self, instance):
        _dict_ = super(DAYOFFActivity, self).model_to_dict(instance)
        status_next_display = ""
        if (
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.dayoff.activity.Manage")')
...
class DAYOFFAuthorization(DAYOFFActivity):

    context = "immediate"

    def get_query(self, *args, **kwargs):
        query = super(DAYOFFAuthorization, self).get_query()
    ...
    def json(self, args=[]):
        self.response["content-type"] = "text/javascript"
        self.response.write(
            'Ext._create("rh.dayoff.activity.authorization.AuthorizeManage")'
        )


class DAYOFFMediateAuthorization(DAYOFFActivity):
    ...
    def get_query(self):
        ...
        if has_perm_mediate_chief():
            query = (
                super(DAYOFFMediateAuthorization, self)
                .get_query()
                .filter(
                    Q(
    ...
    def json(self, args=[]):
        self.response["content-type"] = "text/javascript"
        self.response.write(
            'Ext._create("rh.dayoff.activity.authorization.MediateAuthorizeManage")'
        )


class DAYOFFMediateAuthorizationChart(DAYOFFMediateAuthorization):

    def get_query(self):
        query = super(DAYOFFMediateAuthorizationChart, self).get_query()
    ...
    def json(self, args=[]):
        self.response["content-type"] = "text/javascript"
        self.response.write(
            'Ext._create("rh.dayoff.activity.authorization.MediateAuthorizeChartManage")'
        )


class DAYOFFAdminAuthorization(DAYOFFActivity):
    context = "admin"

    def json(self, args=[]):
        self.response["content-type"] = "text/javascript"
        self.response.write(
            'Ext._create("rh.dayoff.activity.authorization.AdminAuthorizeManage")'
        )


class DAYOFFSellActivity(DAYOFFActivity):

    _model = ActivitySell

    def json(self, args=[]):
        self.response["content-type"] = "text/javascript"
        self.response.write('Ext._create("rh.dayoff.activity.sell.Manage")')


class DAYOFFHomologate(DAYOFFActivity):
    ...
    def get_query(self, *args, **kwargs):
        ...
        if has_perm_homologate_admin() or has_perm_homologate():
            query = super(DAYOFFHomologate, self).get_query()
        return query

    def json(self, args=[]):
        self.response["content-type"] = "text/javascript"
        self.response.write(
            'Ext._create("rh.dayoff.activity.authorization.HomologateManage")'
        )

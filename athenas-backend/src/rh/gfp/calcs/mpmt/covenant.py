...
@RunCodeManager.register("gfp-mpmt-sindsemp")
...
@RunCodeManager.register("gfp-mpmt-fenasemp")
...
@RunCodeManager.register("gfp-mpmt-asamp")
...
@RunCodeManager.register("gfp-mpmt-atmp")
...
@RunCodeManager.register("gfp-mpmt-atmp-13salario")
...
@RunCodeManager.register("gfp-mpmt-plansaude-monthly-payment")

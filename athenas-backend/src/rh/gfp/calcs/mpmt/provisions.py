...
from rh.gfp.calcs.mpmt.ferias import BaseVacation
from rh.gfp.calcs.mpmt.remuneracao import ChristmasGratification
from rh.gfp.calcs.mpmt.socialsecurity import BaseSocialSecurity
...
# @RunCodeManager.register('gfp-mpmt-provision-13thsalary')
...
# @RunCodeManager.register('gfp-mpmt-provision-socialsecurity')
...
@RunCodeManager.register("gfp-mpmt-provision-socialsecurity-christmas")
...
@RunCodeManager.register("gfp-mpmt-provision-vacation")
...
class ChristmasGenerator(ProvisionGenerator):
    ...
    def create_period_for_employee(self, provision_manager, employee, task=None):
        ...
        log.debug(
            "SERVIDOR: %s DTREL %s INICIO %s FIM %s"

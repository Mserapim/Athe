...
from rh.gfp.models import RemunerationRelationship


log = getLogger(__name__)


class GFPRemunerationRelationship(RestfulDRY):

    _model = RemunerationRelationship
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.gfp.remunerationrelationship.Manage")')

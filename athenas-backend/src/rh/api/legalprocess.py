...
class RHLegalProcess(RestfulDRY):
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.legalprocess.LegalProcessManage")')


class RHProcessSuspension(RestfulDRY):

    _model = ProcessSuspension
    ...
    def json(self, args=[]):
        self.response["content-type"] = "text/javascript"
        self.response.write('Ext._create("rh.legalprocess.ProcessSuspensionManage")')

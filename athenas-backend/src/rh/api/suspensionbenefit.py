...
from rh.models import SuspensionBenefit


log = getLogger(__name__)


class RHSuspensionBenefit(RestfulDRY):

    _model = SuspensionBenefit
    ...
    def json(self, args=[]):
        ...
        self.response.write(
            'Ext._create("rh.movimentacao.possession.benefit.suspensionbenefit.Manage")'
        )

...
from rh.models import AnotacaoFolgaEleitoral

log = getLogger(__name__)


class RHAnotacaoFolgaEleitoralRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoFolgaEleitoral
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaofolgaeleitoral.Manage")')

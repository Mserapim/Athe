...
from rh.models import AnotacaoEleitoral

log = getLogger(__name__)


class RHAnotacaoEleitoralRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoEleitoral
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaoeleitoral.Manage")')

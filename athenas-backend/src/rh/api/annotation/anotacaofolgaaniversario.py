...
from rh.models import AnotacaoFolgaAniversario

log = getLogger(__name__)


class RHAnotacaoFolgaAniversarioRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoFolgaAniversario
    ...
    def json(self, args=[]):
        ...
        self.response.write(
            'Ext._create("rh.anotacao.anotacaofolgaaniversario.Manage")'
        )

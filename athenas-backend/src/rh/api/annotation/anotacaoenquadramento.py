...
from rh.models import AnotacaoEnquadramento

log = getLogger(__name__)


class RHAnotacaoEnquadramentoRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoEnquadramento
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaoenquadramento.Manage")')

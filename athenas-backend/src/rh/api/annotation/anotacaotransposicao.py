...
from rh.models import AnotacaoTransposicao

log = getLogger(__name__)


class RHAnotacaoTransposicaoRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoTransposicao
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaotransposicao.Manage")')

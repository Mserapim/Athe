...
from rh.models import AnotacaoPlantao

log = getLogger(__name__)


class RHAnotacaoPlantaoRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoPlantao
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaoplantao.Manage")')

...
from rh.models import AnotacaoElogio

log = getLogger(__name__)


class RHAnotacaoElogioRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoElogio
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaoelogio.Manage")')

...
from rh.models import AnotacaoTempoServico

log = getLogger(__name__)


class RHAnotacaoTempoServicoRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoTempoServico
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaotemposervico.Manage")')

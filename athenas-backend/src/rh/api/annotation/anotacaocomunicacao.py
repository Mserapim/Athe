...
from rh.models import AnotacaoComunicacao

log = getLogger(__name__)


class RHAnotacaoComunicacaoRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoComunicacao
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaocomunicacao.Manage")')

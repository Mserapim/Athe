...
from rh.models import AnotacaoAusencia

log = getLogger(__name__)


class RHAnotacaoAusenciaRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoAusencia
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaoausencia.Manage")')

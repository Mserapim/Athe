...
from rh.models import AnotacaoFalta

log = getLogger(__name__)


class RHAnotacaoFaltaRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoFalta
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaofalta.Manage")')

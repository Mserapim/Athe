...
from rh.models import AnotacaoViagem

log = getLogger(__name__)


class RHAnotacaoViagemRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoViagem
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaoviagem.Manage")')

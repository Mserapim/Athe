...
from rh.models import AnotacaoTempoDobro

log = getLogger(__name__)


class RHAnotacaoTempoDobroRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoTempoDobro
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaotempodobro.Manage")')

...
from rh.models import AnotacaoHorarioEspecial

log = getLogger(__name__)


class RHAnotacaoHorarioEspecialRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoHorarioEspecial
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaohorarioespecial.Manage")')

...
from rh.models import AnotacaoAfastamento

log = getLogger(__name__)


class RHAnotacaoAfastamentoRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoAfastamento
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("rh.anotacao.anotacaoafastamento.Manage")')

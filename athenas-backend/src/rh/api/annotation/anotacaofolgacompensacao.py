...
from rh.models import AnotacaoFolgaCompensacao

log = getLogger(__name__)


class RHAnotacaoFolgaCompensacaoRestful(RHAnotacaoGeralRestful):

    _model = AnotacaoFolgaCompensacao
    ...
    def json(self, args=[]):
        ...
        self.response.write(
            'Ext._create("rh.anotacao.anotacaofolgacompensacao.Manage")'
        )

...
def register_statics():
    ...
    js_paths = (
        "/%(context)s/static/rh/profile/JobProfileRestful.js",
        "/%(context)s/static/rh/profile/JobProfileWindow.js",
        "/%(context)s/static/rh/profile/JobProfileGrid.js",
        "/%(context)s/static/rh/profile/JobProfileManage.js",
    )

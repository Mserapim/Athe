...
from common.document_access.models import LegalPrerogative


log = getLogger(__name__)


class DALegalPrerogative(RestfulDRY):

    _model = LegalPrerogative
    ...
    def json(self, args=[]):
        ...
        self.response.write(
            'Ext._create("common.document_access.legalprerogative.Manage")'
        )

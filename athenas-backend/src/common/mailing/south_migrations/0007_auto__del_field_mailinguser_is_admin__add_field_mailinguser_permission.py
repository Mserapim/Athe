...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MailingUser.is_admin'
        db.delete_column("mailing_mailinguser", "is_admin")

        # Adding field 'MailingUser.permission'
        db.add_column(
            "mailing_mailinguser",
            "permission",
            self.gf("django.db.models.fields.CharField")(
                default="basic", max_length=12, null=True, db_index=True
            ),
            keep_default=False,
        )

    def backwards(self, orm):
        # Adding field 'MailingUser.is_admin'
        db.add_column(
            "mailing_mailinguser",
            "is_admin",
        ...
        # Deleting field 'MailingUser.permission'
        db.delete_column("mailing_mailinguser", "permission")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
            ...
            (
                ...
                (
                    ...
                    self.gf("django.db.models.fields.related.OneToOneField")(
                        related_name="mailing_user", unique=True, to=orm["auth.User"]
                    ),
                ),
                (
                    "is_admin",
        ...
        db.send_create_signal("mailing", ["MailingUser"])

    def backwards(self, orm):
        # Deleting model 'MailingUser'
        db.delete_table("mailing_mailinguser")

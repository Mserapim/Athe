...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Common', fields ['slug']
        db.delete_unique("mailing_common", ["slug"])

    def backwards(self, orm):
        # Adding unique constraint on 'Common', fields ['slug']
        db.create_unique("mailing_common", ["slug"])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaseConhecimento.solucao'
        db.delete_column("siatu_base_conhecimento", "solucao")

        # Deleting field 'BaseConhecimento.solucao_tmp'
        db.rename_column("siatu_base_conhecimento", "solucao_tmp", "solucao")

    def backwards(self, orm):

        db.rename_column("siatu_base_conhecimento", "solucao", "solucao_tmp")
    ...
    models = {
        ...
        "siatu.baseconhecimento": {
            ...
            "solucao_1": ("django.db.models.fields.TextField", [], {}),
        },
        "siatu.chamado": {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Avaliacao.tipo_avaliacao'
        db.delete_column("siatu_avaliacao", "tipo_avaliacao_id")

    def backwards(self, orm):
        # Adding field 'Avaliacao.tipo_avaliacao'
        db.add_column(
            "siatu_avaliacao",
            "tipo_avaliacao",
            self.gf("django.db.models.fields.related.ForeignKey")(
                default=0, to=orm["siatu.TipoAvaliacao"]
            ),
            keep_default=False,
        )

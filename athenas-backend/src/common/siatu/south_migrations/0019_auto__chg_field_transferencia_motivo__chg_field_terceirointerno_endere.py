...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Solicitacao.telefone'
        db.add_column(
            "siatu_solicitacao",
            "telefone",
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Solicitacao.telefone'
        db.delete_column("siatu_solicitacao", "telefone")
    ...
    models = {
        ...
        "siatu.baseconhecimento": {
            ...
            "solucao": ("django.db.models.fields.TextField", [], {"null": "True"}),
        },
        "siatu.chamado": {

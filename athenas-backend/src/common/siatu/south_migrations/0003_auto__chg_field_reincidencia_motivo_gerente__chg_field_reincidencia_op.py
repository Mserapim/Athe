...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reincidencia.motivo_gerente'
        db.alter_column(
            "siatu_reincidencia",
            "motivo_gerente",
        ...
        # # Changing field 'Reincidencia.opiniao_atendente'
        db.alter_column(
            "siatu_reincidencia",
            "opiniao_atendente",
            self.gf("django.db.models.fields.CharField")(max_length=300, null=True),
        )
        # # Adding field 'BaseConhecimento.solucao_tmp'
        db.add_column(
            "siatu_base_conhecimento",
            "solucao_tmp",
            self.gf("django.db.models.fields.TextField")(default="nada"),
            keep_default=False,
        )

        for bc in orm["siatu.BaseConhecimento"].objects.all():
            bc.solucao_tmp = bc.solucao
            bc.save()
    ...
    def backwards(self, orm):
        ...
        db.alter_column(
            ...
            "opiniao_atendente",
            self.gf("django.db.models.fields.CharField")(
                default="nada", max_length=300
            ),
        )
        # Deleting field 'BaseConhecimento.solucao_tmp'
        db.delete_column("siatu_base_conhecimento", "solucao_tmp")
    ...
    models = {
        ...
        "siatu.baseconhecimento": {
            ...
            "solucao_tmp": ("django.db.models.fields.TextField", [], {}),
        },
        "siatu.chamado": {

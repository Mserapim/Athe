...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseConhecimento.informatica'
        db.add_column(
        ...
        # Adding field 'Objeto.informatica'
        db.add_column(
            "siatu_objeto",
            "informatica",
            self.gf("django.db.models.fields.BooleanField")(default=False),
    ...
    def backwards(self, orm):
        # Deleting field 'BaseConhecimento.informatica'
        db.delete_column("siatu_base_conhecimento", "informatica")

        # Deleting field 'Objeto.informatica'
        db.delete_column("siatu_objeto", "informatica")

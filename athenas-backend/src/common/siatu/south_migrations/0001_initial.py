...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal("siatu", ["Objeto"])

        # Adding model 'BaseConhecimento'
        db.create_table(
            "siatu_base_conhecimento",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
                    "objeto",
                ...
                (
                    ...
                    self.gf("django.db.models.fields.related.OneToOneField")(
                        related_name="+", unique=True, null=True, to=orm["ged.Arquivo"]
                    ),
                ),
            ),
        )
        db.send_create_signal("siatu", ["BaseConhecimento"])

        # Adding unique constraint on 'BaseConhecimento', fields ['objeto', 'modelo', 'problema', 'solucao']
        db.create_unique(
            "siatu_base_conhecimento", ["objeto_id", "modelo", "problema", "solucao"]
        )

        # Adding model 'ItemBaseConhecimento'
        db.create_table(
            "siatu_item_base_conhecimento",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
                    "chamado",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        related_name="itens_base_conhecimento", to=orm["siatu.Chamado"]
                    ),
                ),
                (
                    "base_conhecimento",
        ...
        db.send_create_signal("siatu", ["ItemBaseConhecimento"])

        # Adding unique constraint on 'ItemBaseConhecimento', fields ['chamado', 'base_conhecimento']
        db.create_unique(
            "siatu_item_base_conhecimento", ["chamado_id", "base_conhecimento_id"]
        )

        # Adding model 'FilaUnica'
        db.create_table(
            "siatu_fila_unica",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
        ...
        db.send_create_signal("siatu", ["FilaUnica"])

        # Adding unique constraint on 'FilaUnica', fields ['servico', 'localidade']
        db.create_unique("siatu_fila_unica", ["servico_id", "localidade"])

        # Adding model 'DistribuicaoAutomatica'
        db.create_table(
            "siatu_distribuicao_automatica",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
                    "servico",
        ...
        db.send_create_signal("siatu", ["DistribuicaoAutomatica"])

        # Adding M2M table for field solicitantes on 'DistribuicaoAutomatica'
        db.create_table(
            "siatu_distribuicao_automat437d",
            (
                (
                    "id",
                    models.AutoField(
                ...
                (
                    ...
                    models.ForeignKey(orm["siatu.distribuicaoautomatica"], null=False),
                ),
                ("user", models.ForeignKey(orm["auth.user"], null=False)),
            ),
        )
        db.create_unique(
            "siatu_distribuicao_automat437d", ["distribuicaoautomatica_id", "user_id"]
        )
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "servico_superior",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        related_name="subservicos", null=True, to=orm["siatu.Servico"]
                    ),
                ),
            ),
        )
        db.send_create_signal("siatu", ["Servico"])

        # Adding M2M table for field lista_gerentes on 'Servico'
        db.create_table(
            "siatu_servico_lista_gerentes",
            (
                (
                    "id",
                    models.AutoField(
                ...
                ("servico", models.ForeignKey(orm["siatu.servico"], null=False)),
                ("gerente", models.ForeignKey(orm["siatu.gerente"], null=False)),
            ),
        )
        db.create_unique("siatu_servico_lista_gerentes", ["servico_id", "gerente_id"])

        # Adding model 'Atendente'
        db.create_table(
            "siatu_atendente",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
        ...
        db.send_create_signal("siatu", ["Atendente"])

        # Adding model 'AtendentesServicos'
        db.create_table(
            "siatu_atendentes_servicos",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
                    "servico",
        ...
        db.send_create_signal("siatu", ["AtendentesServicos"])

        # Adding unique constraint on 'AtendentesServicos', fields ['servico', 'atendente']
        db.create_unique("siatu_atendentes_servicos", ["servico_id", "atendente_id"])

        # Adding model 'Gerente'
        db.create_table(
            "siatu_gerente",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
        ...
        db.send_create_signal("siatu", ["Gerente"])
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "descricao_problema",
                    self.gf("django.db.models.fields.CharField")(max_length=600),
                ),
                (
                    "reincidencia",
        ...
        db.send_create_signal("siatu", ["Solicitacao"])

        # Adding model 'ConfigEmailSolicitante'
        db.create_table(
            "siatu_configemailsolicitante",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
        ...
        db.send_create_signal("siatu", ["ConfigEmailSolicitante"])

        # Adding model 'ConfigEmailAtendente'
        db.create_table(
            "siatu_configemailatendente",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                (
                    "transferido_atendente",
        ...
        db.send_create_signal("siatu", ["ConfigEmailAtendente"])

        # Adding model 'Reincidencia'
        db.create_table(
            "siatu_reincidencia",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
        ...
        db.send_create_signal("siatu", ["Reincidencia"])

        # Adding model 'Terceirizada'
        db.create_table(
            "siatu_terceirizada",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                ("nome", self.gf("django.db.models.fields.CharField")(max_length=80)),
                ("cnpj", self.gf("django.db.models.fields.CharField")(max_length=50)),
            ),
        )
        db.send_create_signal("siatu", ["Terceirizada"])

        # Adding model 'TerceiroInterno'
        db.create_table(
            "siatu_terceirointerno",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
                ("nome", self.gf("django.db.models.fields.CharField")(max_length=80)),
                ("cpf", self.gf("django.db.models.fields.CharField")(max_length=50)),
                (
                    "telefone",
                    self.gf("django.db.models.fields.CharField")(max_length=50),
                ),
        ...
        db.send_create_signal("siatu", ["TerceiroInterno"])
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "fila",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        related_name="chamados", null=True, to=orm["siatu.FilaUnica"]
                    ),
                ),
                (
                ...
                (
                    "status_atual",
                    self.gf("django.db.models.fields.related.OneToOneField")(
                        related_name="+", unique=True, null=True, to=orm["siatu.Status"]
                    ),
                ),
                (
        ...
        db.send_create_signal("siatu", ["Chamado"])

        # Adding M2M table for field atendentes on 'Chamado'
        db.create_table(
            "siatu_chamado_atendentes",
            (
                (
                    "id",
                    models.AutoField(
                ...
                ("chamado", models.ForeignKey(orm["siatu.chamado"], null=False)),
                ("atendente", models.ForeignKey(orm["siatu.atendente"], null=False)),
            ),
        )
        db.create_unique("siatu_chamado_atendentes", ["chamado_id", "atendente_id"])

        # Adding M2M table for field terceirizada on 'Chamado'
        db.create_table(
            "siatu_chamado_terceirizada",
            (
                (
                    "id",
                    models.AutoField(
                ...
                (
                    "terceirizada",
                    models.ForeignKey(orm["siatu.terceirizada"], null=False),
                ),
            ),
        )
        db.create_unique(
            "siatu_chamado_terceirizada", ["chamado_id", "terceirizada_id"]
        )

        # Adding M2M table for field terceiro_interno on 'Chamado'
        db.create_table(
            "siatu_chamado_terceiro_interno",
            (
                (
                    "id",
                    models.AutoField(
                ...
                (
                    "terceirointerno",
                    models.ForeignKey(orm["siatu.terceirointerno"], null=False),
                ),
            ),
        )
        db.create_unique(
            "siatu_chamado_terceiro_interno", ["chamado_id", "terceirointerno_id"]
        )

        # Adding model 'TipoAvaliacao'
        db.create_table(
            "siatu_tipoavaliacao",
            (
                ("id", self.gf("django.db.models.fields.AutoField")(primary_key=True)),
        ...
        db.send_create_signal("siatu", ["TipoAvaliacao"])
        ...
        db.send_create_signal("siatu", ["Avaliacao"])
        ...
        db.send_create_signal("siatu", ["Anexo"])
        ...
        db.create_table(
            ...
            (
                ...
                ("data_pedido", self.gf("django.db.models.fields.DateTimeField")()),
                (
                    "data_aceite",
                    self.gf("django.db.models.fields.DateTimeField")(null=True),
                ),
        ...
        db.send_create_signal("siatu", ["Transferencia"])

        # Adding M2M table for field atendente_anterior on 'Transferencia'
        db.create_table(
            "siatu_transferencia_atende4849",
            (
                (
                    "id",
                    models.AutoField(
                ...
                (
                    "transferencia",
                    models.ForeignKey(orm["siatu.transferencia"], null=False),
                ),
                ("atendente", models.ForeignKey(orm["siatu.atendente"], null=False)),
            ),
        )
        db.create_unique(
            "siatu_transferencia_atende4849", ["transferencia_id", "atendente_id"]
        )

        # Adding M2M table for field atendente_posterior on 'Transferencia'
        db.create_table(
            "siatu_transferencia_atendea7cb",
            (
                (
                    "id",
                    models.AutoField(
        ...
        db.create_unique(
            "siatu_transferencia_atendea7cb", ["transferencia_id", "atendente_id"]
        )
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "terceirizada",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        related_name="+", null=True, to=orm["siatu.Terceirizada"]
                    ),
                ),
                (
                    "motivo",
        ...
        db.send_create_signal("siatu", ["Status"])

    def backwards(self, orm):
        # Removing unique constraint on 'AtendentesServicos', fields ['servico', 'atendente']
        db.delete_unique("siatu_atendentes_servicos", ["servico_id", "atendente_id"])

        # Removing unique constraint on 'FilaUnica', fields ['servico', 'localidade']
        db.delete_unique("siatu_fila_unica", ["servico_id", "localidade"])

        # Removing unique constraint on 'ItemBaseConhecimento', fields ['chamado', 'base_conhecimento']
        db.delete_unique(
            "siatu_item_base_conhecimento", ["chamado_id", "base_conhecimento_id"]
        )

        # Removing unique constraint on 'BaseConhecimento', fields ['objeto', 'modelo', 'problema', 'solucao']
        db.delete_unique(
            "siatu_base_conhecimento", ["objeto_id", "modelo", "problema", "solucao"]
        )

        # Deleting model 'Objeto'
        db.delete_table("siatu_objeto")

        # Deleting model 'BaseConhecimento'
        db.delete_table("siatu_base_conhecimento")

        # Deleting model 'ItemBaseConhecimento'
        db.delete_table("siatu_item_base_conhecimento")

        # Deleting model 'FilaUnica'
        db.delete_table("siatu_fila_unica")

        # Deleting model 'DistribuicaoAutomatica'
        db.delete_table("siatu_distribuicao_automatica")

        # Removing M2M table for field solicitantes on 'DistribuicaoAutomatica'
        db.delete_table("siatu_distribuicao_automat437d")

        # Deleting model 'Servico'
        db.delete_table("siatu_servico")

        # Removing M2M table for field lista_gerentes on 'Servico'
        db.delete_table("siatu_servico_lista_gerentes")

        # Deleting model 'Atendente'
        db.delete_table("siatu_atendente")

        # Deleting model 'AtendentesServicos'
        db.delete_table("siatu_atendentes_servicos")

        # Deleting model 'Gerente'
        db.delete_table("siatu_gerente")

        # Deleting model 'Solicitacao'
        db.delete_table("siatu_solicitacao")

        # Deleting model 'ConfigEmailSolicitante'
        db.delete_table("siatu_configemailsolicitante")

        # Deleting model 'ConfigEmailAtendente'
        db.delete_table("siatu_configemailatendente")

        # Deleting model 'Reincidencia'
        db.delete_table("siatu_reincidencia")

        # Deleting model 'Terceirizada'
        db.delete_table("siatu_terceirizada")

        # Deleting model 'TerceiroInterno'
        db.delete_table("siatu_terceirointerno")

        # Deleting model 'Chamado'
        db.delete_table("siatu_chamado")

        # Removing M2M table for field atendentes on 'Chamado'
        db.delete_table("siatu_chamado_atendentes")

        # Removing M2M table for field terceirizada on 'Chamado'
        db.delete_table("siatu_chamado_terceirizada")

        # Removing M2M table for field terceiro_interno on 'Chamado'
        db.delete_table("siatu_chamado_terceiro_interno")

        # Deleting model 'TipoAvaliacao'
        db.delete_table("siatu_tipoavaliacao")

        # Deleting model 'Avaliacao'
        db.delete_table("siatu_avaliacao")

        # Deleting model 'Anexo'
        db.delete_table("siatu_anexo")

        # Deleting model 'Transferencia'
        db.delete_table("siatu_transferencia")

        # Removing M2M table for field atendente_anterior on 'Transferencia'
        db.delete_table("siatu_transferencia_atende4849")

        # Removing M2M table for field atendente_posterior on 'Transferencia'
        db.delete_table("siatu_transferencia_atendea7cb")

        # Deleting model 'Status'
        db.delete_table("siatu_status")
    ...
    models = {
        ...
        "siatu.baseconhecimento": {
            "Meta": {
                ...
                "unique_together": "(('objeto', 'modelo', 'problema', 'solucao'),)",
            ...
            "solucao": ("django.db.models.fields.CharField", [], {"max_length": "300"}),
        },
        "siatu.chamado": {
        ...
        "siatu.terceirointerno": {
            "Meta": {"object_name": "TerceiroInterno"},

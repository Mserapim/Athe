...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column("siatu_base_conhecimento", "modelo")
        db.rename_column("siatu_base_conhecimento", "modelo_tmp_id", "modelo_id")

    def backwards(self, orm):
        db.rename_column("siatu_base_conhecimento", "modelo_id", "modelo_tmp_id")
        db.add_column(

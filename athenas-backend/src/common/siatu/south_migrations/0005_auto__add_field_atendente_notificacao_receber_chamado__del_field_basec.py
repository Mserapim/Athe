...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Atendente.notificacao_receber_chamado'
        db.add_column(
            "siatu_atendente",
    ...
    def backwards(self, orm):
        # Deleting field 'Atendente.notificacao_receber_chamado'
        db.delete_column("siatu_atendente", "notificacao_receber_chamado")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Avaliacao.presteza'
        db.add_column(
            "siatu_avaliacao",
            "presteza",
        ...
        # Adding field 'Avaliacao.esclarecimento'
        db.add_column(
            "siatu_avaliacao",
            "esclarecimento",
            self.gf("django.db.models.fields.SmallIntegerField")(default=0),
        ...
        # Adding field 'Avaliacao.satisfacao'
        db.add_column(
            "siatu_avaliacao",
            "satisfacao",
            self.gf("django.db.models.fields.SmallIntegerField")(default=0),
    ...
    def backwards(self, orm):
        # Deleting field 'Avaliacao.presteza'
        db.delete_column("siatu_avaliacao", "presteza")

        # Deleting field 'Avaliacao.esclarecimento'
        db.delete_column("siatu_avaliacao", "esclarecimento")

        # Deleting field 'Avaliacao.tempo'
        db.delete_column("siatu_avaliacao", "tempo")

        # Deleting field 'Avaliacao.satisfacao'
        db.delete_column("siatu_avaliacao", "satisfacao")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Chamado.cache_numero'
        db.add_column(
            "siatu_chamado",
            "cache_numero",
            self.gf("django.db.models.fields.CharField")(
                default="0", max_length=10, db_index=True
            ),
            keep_default=False,
        )

    def backwards(self, orm):
        # Deleting field 'Chamado.numero'
        db.delete_column("siatu_chamado", "numero")

        # Deleting field 'Chamado.ano'
        db.delete_column("siatu_chamado", "ano")

        # Deleting field 'Chamado.cache_numero'
        db.delete_column("siatu_chamado", "cache_numero")

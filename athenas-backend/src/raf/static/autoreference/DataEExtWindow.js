...
Ext._define('raf.autoreference.DataEExtWindow', {
    extend: 'Ext.Window',
        ...
        if(!this._factoryStore) {
            this._factoryStore = Ext._create('Ext.data.Store', {
                  ...
                  proxy: Ext._create('Ext.data.HttpProxy', {
                      url: core.callAction('RAFAutoReference', 'get_dataeext')
                  }),
                  baseParams: {
                  ...
                  reader: Ext._create('Ext.data.JsonReader', {
                      ...
                      fields: [
                          ...
                          {name: 'classe', type: 'auto'},
                          {name: 'assuntoprincipal', type: 'auto'},
                          {name: 'movimento', type: 'auto'},
                          {name: 'datamovimento', type: 'auto'},
                      ]
                  })
              });
    ...
    constructor: function(cfg) {
        ...
        Ext.applyIf(cfg, {
            title: 'E-EXT - Atuação Ministerial',
            width: 910,
            height: 350,
        });
        ...
        raf.autoreference.DataEExtWindow.superclass.constructor.call(this, cfg);

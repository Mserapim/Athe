...
Ext._define('raf.report.ProductivityReportPeriodWindow', {
    extend: 'raf.report.BaseWindow',

    report: '/to/mpe/raf/produtividade_raf',

    _reportName: 'Produtividade por Período/Membro/Lotação',
    ...
    getValues: function() {
        ...
        if (values.employee == "" ) {
          ...
          values.message = 'Selecione um membro para geração da produtividade.';
        } else {
    ...
    constructor: function(cfg) {
        ...
        raf.report.ProductivityReportPeriodWindow.superclass.constructor.call(this, cfg);

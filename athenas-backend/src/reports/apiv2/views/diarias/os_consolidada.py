...
class OsConsolidadaDiariasView(ReportBaseView):
    """
    View para realizar o download da Os do Beneficiario do Diarias
    """
    ...
    def gerar_relatorio(self):
        ...
        relatorio = "portrait/mpmt/diarias/os_consolidada/template.html"
        params = {
            "outfile": "portrait/mpmt/diarias/os_consolidada/template.html",
            "report_name": "OS-Consolidado",
            "id_beneficiario": self.request.data.get("id_beneficiario", None),
            "output_format": "PDF",

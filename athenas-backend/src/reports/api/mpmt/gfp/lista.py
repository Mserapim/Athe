...
from reports.data.mpmt.gfp.lista import get_data_report
...
class ListaReport(MPMTReports):
    ...
    @login_required("JSON")
    def generate_lista_csv(self, *args):
        ...
        if not self.request.POST.get(
            ...
            try:
                report = ""
                params = {
                    "report_name": "Lista - Relatório Salarial",

...
from reports.data.mpmt.reportmodels.identificationpdf import get_data_report
from ged.models import Arquivo
from engine.mq.models import Task
from contrib.middleware import get_current_user

# from reports.tasks import write_pdf_task

log = getLogger(__name__)
json = get_json_engine()


class IdentificationPdf(MPMTReports):
    ...
    @login_required("JSON")
    def generate_identification_pdf(self, *args):
        try:
    ...
    def generates_pdf(self, report, params):
        """
        Parâmetros:
        ...
        try:
            ...
            obj.update(
                success=True,
                # uuid = task.uuid,
                message="Relatório descontinuado.",
                download=True,
            )
        except Exception as e:
            log.exception(e)

Ext._define('corregedoria.cirdir.Manage', {
  extend: 'toolkit.widget.TabPanel',
    ...
    getGrid: function(cfg) {
        if(!this._grid) {
            this._grid = Ext._create('corregedoria.cirdir.Grid', {
                ...
                configOrderToolBar: ['menu', 'applyFilter', 'reports', '->', '-', 'search'],
    ...
    observerEmployee: function(cfg) {
        ...
        if (this.admin == true) {
            this.getGrid(cfg).getMenuAction().show();
            this.getGrid(cfg).getApplyFilterAction().show();
            this.getGrid(cfg).getReportsAction().show();
    ...
    constructor: function(cfg) {
        ...
        corregedoria.cirdir.Manage.superclass.constructor.call(this, cfg);

...
Ext._define('corregedoria.cirdir.OpenWindow', {
                ...
                items: [
                    {
                        ...
                        items: [
                            {
                                fieldLabel: 'Selecione o ano que deseja abrir',
                                xtype: 'combo',
                                hiddenName: 'year',
                                width: 75,
                                editable: false,
    ...
    openAll: function(cfg) {
        ...
        if (values) {
            ...
            Ext.Ajax.request({
                scope: this,
                url: core.callAction('CIRDIRControlInformation', 'open_all'),
                callback: function() {
    ...
    constructor: function(cfg) {
        ...
        corregedoria.cirdir.OpenWindow.superclass.constructor.call(this, cfg);
    }
});

Ext._define('corregedoria.prontuary.career.termination.exoneration.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.career.termination.exoneration.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.career.termination.exoneration.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function(cfg) {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detailexoneration: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detailexoneration_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.career.termination.exoneration.Window.superclass.constructor.call(this, cfg);
        this.observer(cfg);
    },

Ext._define('corregedoria.prontuary.career.movement.promotion.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.career.movement.promotion.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.career.movement.promotion.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function(cfg) {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detailpromotion: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detailpromotion_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.career.movement.promotion.Window.superclass.constructor.call(this, cfg);
        this.observer(cfg);
    },

Ext._define('corregedoria.prontuary.career.designation.partieshearings.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.career.designation.partieshearings.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.career.designation.partieshearings.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function(cfg) {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detailpartieshearings: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detailpartieshearings_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.career.designation.partieshearings.Window.superclass.constructor.call(this, cfg);
        this.observer(cfg);
    },

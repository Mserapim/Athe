Ext._define('corregedoria.prontuary.individualperformance.integrateworkgroup.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.individualperformance.integrateworkgroup.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.individualperformance.integrateworkgroup.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function() {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detailintegrateworkgroup: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detailintegrateworkgroup_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.individualperformance.integrateworkgroup.Window.superclass.constructor.call(this, cfg);
        this.observer();
    },

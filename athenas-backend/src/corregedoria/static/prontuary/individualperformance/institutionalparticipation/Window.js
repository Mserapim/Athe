Ext._define('corregedoria.prontuary.individualperformance.institutionalparticipation.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.individualperformance.institutionalparticipation.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.individualperformance.institutionalparticipation.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function() {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detailinstitutionalparticipation: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detailinstitutionalparticipation_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.individualperformance.institutionalparticipation.Window.superclass.constructor.call(this, cfg);
        this.observer();
    },

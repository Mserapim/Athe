Ext._define('corregedoria.inspection.inspection.filling.functionalperformance.procforqualanalysisofthepartselectoral.Restful', {
    extend: 'core.Restful',

    resource: 'INSPECTIONProcForQualAnalysisOfThePartsElectoral',

    getFields: function(cfg) {
        if(!this._fields)
            this._fields = corregedoria.inspection.inspection.filling.functionalperformance.procforqualanalysisofthepartselectoral.Restful.superclass.getFields.call(this, cfg).concat([

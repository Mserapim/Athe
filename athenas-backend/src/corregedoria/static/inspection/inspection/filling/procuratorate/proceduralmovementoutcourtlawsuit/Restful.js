Ext._define('corregedoria.inspection.inspection.filling.procuratorate.proceduralmovementoutcourtlawsuit.Restful', {
    extend: 'core.Restful',

    resource: 'INSPECTIONProceduralMovementOutCourtLawsuit',

    getFields: function(cfg) {
        if(!this._fields)
            this._fields = corregedoria.inspection.inspection.filling.procuratorate.proceduralmovementoutcourtlawsuit.Restful.superclass.getFields.call(this, cfg).concat([
                {type: "int", name: "year"},

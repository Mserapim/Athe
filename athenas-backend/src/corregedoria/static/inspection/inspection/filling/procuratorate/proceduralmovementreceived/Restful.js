Ext._define('corregedoria.inspection.inspection.filling.procuratorate.proceduralmovementreceived.Restful', {
    extend: 'core.Restful',

    resource: 'INSPECTIONProceduralMovementReceived',

    getFields: function(cfg) {
        if(!this._fields)
            this._fields = corregedoria.inspection.inspection.filling.procuratorate.proceduralmovementreceived.Restful.superclass.getFields.call(this, cfg).concat([
                {type: "int", name: "year"},

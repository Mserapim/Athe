Ext._define('corregedoria.inspection.inspection.filling.Launcher_especialgroup', {
    extend: 'Ext.Window',
    ...
    constructor: function(cfg) {
        ...
        Ext.applyIf(cfg, {
            title: 'Gestor de Inspeções/Correições - GROUPS ESPECIAIS',
            width: 1200,
            height: 800,
        });
        ...
        corregedoria.inspection.inspection.filling.Launcher_especialgroup.superclass.constructor.call(this, cfg);
        if (cfg) {
            this.getFormPanel(cfg).getForm().setValues({

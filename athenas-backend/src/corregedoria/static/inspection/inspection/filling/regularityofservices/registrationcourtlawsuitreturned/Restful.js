Ext._define('corregedoria.inspection.inspection.filling.regularityofservices.registrationcourtlawsuitreturned.Restful', {
    extend: 'core.Restful',

    resource: 'INSPECTIONRegistrationCourtLawsuitReturned',

    getFields: function(cfg) {
        if(!this._fields)
            this._fields = corregedoria.inspection.inspection.filling.regularityofservices.registrationcourtlawsuitreturned.Restful.superclass.getFields.call(this, cfg).concat([
                {type: "int", name: "year"},

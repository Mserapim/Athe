...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Application', fields ['title', 'father']
        db.create_unique("engine_application", ["title", "father_id"])

    def backwards(self, orm):
        # Removing unique constraint on 'Application', fields ['title', 'father']
        db.delete_unique("engine_application", ["title", "father_id"])

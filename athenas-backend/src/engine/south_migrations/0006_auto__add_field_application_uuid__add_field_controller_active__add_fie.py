...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(
            ...
            self.gf("django.db.models.fields.CharField")(
                db_index=True, max_length=32, unique=True, null=True, blank=True
            ),
            keep_default=False,
        )

        # Adding field 'Controller.active'
        db.add_column(
            "engine_controller",
            "active",
        ...
        # Adding field 'Controller.module'
        db.add_column(
            "engine_controller",
            "module",
            self.gf("django.db.models.fields.CharField")(
    ...
    def backwards(self, orm):
        ...
        db.delete_column("engine_application", "uuid")

        # Deleting field 'Controller.active'
        db.delete_column("engine_controller", "active")

        # Deleting field 'Controller.module'
        db.delete_column("engine_controller", "module")

        # Deleting field 'Controller.uuid'
        db.delete_column("engine_controller", "uuid")

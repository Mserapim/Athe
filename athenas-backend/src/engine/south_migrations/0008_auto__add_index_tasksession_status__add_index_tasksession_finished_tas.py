...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TaskSession', fields ['status']
        db.create_index("eng_tasksession", ["status"])

        # Adding index on 'TaskSession', fields ['finished_task']
        db.create_index("eng_tasksession", ["finished_task"])

        # Adding index on 'TaskSession', fields ['sid']
        db.create_index("eng_tasksession", ["sid"])

        # Adding index on 'TaskSession', fields ['started_task']
        db.create_index("eng_tasksession", ["started_task"])

        # Adding index on 'TaskMessages', fields ['type_of']
        db.create_index("eng_taskmessages", ["type_of"])

    def backwards(self, orm):
        # Removing index on 'TaskMessages', fields ['type_of']
        db.delete_index("eng_taskmessages", ["type_of"])

        # Removing index on 'TaskSession', fields ['started_task']
        db.delete_index("eng_tasksession", ["started_task"])

        # Removing index on 'TaskSession', fields ['sid']
        db.delete_index("eng_tasksession", ["sid"])

        # Removing index on 'TaskSession', fields ['finished_task']
        db.delete_index("eng_tasksession", ["finished_task"])

        # Removing index on 'TaskSession', fields ['status']
        db.delete_index("eng_tasksession", ["status"])
    ...
    models = {
        ...
        "engine.tasksession": {
            ...
            "status": (
                "django.db.models.fields.CharField",
                [],
                {"default": "'RUNNING'", "max_length": "16", "db_index": "True"},
            ),
            "user": (
                "django.db.models.fields.related.ForeignKey",
                [],

 ...
 *
 **/
Ext._define('engine.JobProfileManage', {
    extend: 'toolkit.widget.TabPanel',

    getJobProfileGrid: function() {
        if(!this._jobProfileGrid) {
            this._jobProfileGrid = Ext._create('engine.JobProfileGrid', {
                gridAutoLoad: false,
                region: 'north',
                minHeight: 300,
                height: 300,
    ...
    getWorkplaceGrid: function() {
        if(!this._workplaceGrid) {
            this._workplaceGrid = Ext._create('rh.workplace.Grid', {
                ...
                hideColumns: [
                    'executivo', 'data_alteracao', 'andar', 'esfera_governamental_display',
                    'comarca_unicode', 'pai_unicode', 'responsavel_unicode',
                    'acesso_protocolo_geral', 'descricao', 'order_nome', 'habilita_protocolo',
                    'codigo', 'nome', 'grupo_lotacao', 'localidade_unicode', 'ouvidoria',
                    'sala', 'administrativo', 'instancia_unicode', 'publica_doc', 'entrancia_unicode',
                    'abreviacao', 'codigo_igeprev', 'poder_display', 'descricao', 'sigla',
                    'ativo', 'organograma', 'lotacionograma', 'designacao'
                ],
                columnAction: false
            });
    ...
    constructor: function(cfg) {
        ...
        // this.callParent([cfg]);
        engine.JobProfileManage.superclass.constructor.call(this, cfg);

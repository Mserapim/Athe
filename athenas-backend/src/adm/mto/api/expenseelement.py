# -*- coding: utf-8 -*-
from adm.mto.models import ElementoDespesa as ExpenseElement
...
class MTOExpenseElement(RestfulDRY):

    _model = ExpenseElement
    ...
    #     self.response.write('Ext._create("adm.mto.expenseelement.Manage")')

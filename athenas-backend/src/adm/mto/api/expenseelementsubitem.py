# -*- coding: utf-8 -*-
from adm.mto.models import ElementoDespesaSubItem as ExpenseElementSubItem
...
class MTOExpenseElementSubItem(RestfulDRY):

    _model = ExpenseElementSubItem
    ...
    #     self.response.write('Ext._create("adm.mto.expenseelement.subitem.Manage")')

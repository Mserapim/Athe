...
from edocs.protocolo.models import GroupPerson
...
class EDOCGroupPerson(RestfulDRY):
    ...
    def get_query(self):
        query = super(EDOCGroupPerson, self).get_query()
    ...
    def json(self, args=[]):
        ...
        self.response.write('Ext._create("edocs.protocolo.GroupPersonManage")')

...
from edocs.protocolo.requestform.models import FinalPaperDayOff
...
class RequestFormFinalPaperDayOff(EDOCManage):

    _model = FinalPaperDayOff

    def prepare_params(self, querydict):
        params = super(RequestFormFinalPaperDayOff, self).prepare_params(querydict)
    ...
    def model_to_dict(self, instance):
        data = super(RequestFormFinalPaperDayOff, self).model_to_dict(instance)

        form = instance.protocolo.finalpaperdayoff

...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        call_command("loaddata", "epad_Application.json")
        call_command("loaddata", "epad_Application2.json")
        call_command("loaddata", "epad_Funcionalidades.json")
        call_command("loaddata", "epad_Funcionalidades2.json")

        [c.save() for c in Controller.objects.filter(controller__icontains="epad")]

        call_command("loaddata", "epad_Assuntos.json")
        call_command("loaddata", "epad_Situacoes.json")
        call_command("loaddata", "epad_Group_Admin.json")

        grupo = Group.objects.get(name="Basico")
        permission1 = Permission.objects.get_by_natural_key(
            "add_processo", "processo", "processo"
        )
        permission2 = Permission.objects.get_by_natural_key(
            "change_processo", "processo", "processo"
        )
        permission3 = Permission.objects.get_by_natural_key(
            "add_assunto", "processo", "assunto"
        )
        permission4 = Permission.objects.get_by_natural_key(
            "change_assunto", "processo", "assunto"
        )
        permission5 = Permission.objects.get_by_natural_key(
            "add_situacao", "processo", "situacao"
        )
        permission6 = Permission.objects.get_by_natural_key(
            "change_situacao", "processo", "situacao"
        )
        permission7 = Permission.objects.get_by_natural_key(
            "add_movimentacaoprocesso", "processo", "movimentacaoprocesso"
        )
        permission8 = Permission.objects.get_by_natural_key(
            "change_movimentacaoprocesso", "processo", "movimentacaoprocesso"
        )
        permission9 = Permission.objects.get_by_natural_key(
            "delete_movimentacaoprocesso", "processo", "movimentacaoprocesso"
        )
        permission10 = Permission.objects.get_by_natural_key(
            "add_referencia", "processo", "referencia"
        )
        permission11 = Permission.objects.get_by_natural_key(
            "change_referencia", "processo", "referencia"
        )
        permission12 = Permission.objects.get_by_natural_key(
            "delete_referencia", "processo", "referencia"
        )
        grupo.permissions.add(permission1)
        grupo.permissions.add(permission2)
        grupo.permissions.add(permission3)
        grupo.permissions.add(permission4)
        grupo.permissions.add(permission5)
        grupo.permissions.add(permission6)
        grupo.permissions.add(permission7)
        grupo.permissions.add(permission8)
        grupo.permissions.add(permission9)
        grupo.permissions.add(permission10)
        grupo.permissions.add(permission11)
        grupo.permissions.add(permission12)

 ...
 *
 **/
Ext._define('adm.patrimonio.reports.AnaliticoAvaliadoWindow', {
    extend: 'adm.patrimonio.reports.BaseWindow',

    report: '/to/mpe/adm/patrimonio/Sintetico_de_Bens_Avaliado',

    _filename: 'analitico-de-bens-avaliado',

    _reportName: 'Analítico de Bens Avaliado',
    ...
    constructor: function(cfg) {
        ...
        // this.callParent([cfg]);
        adm.patrimonio.reports.AnaliticoAvaliadoWindow.superclass.constructor.call(this, cfg);
    }
});

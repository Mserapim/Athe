Ext._define('corregedoria.prontuary.individualperformance.integratestrategicworkgroup.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.individualperformance.integratestrategicworkgroup.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.individualperformance.integratestrategicworkgroup.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function() {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detailintegratestrategicworkgroup: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detailintegratestrategicworkgroup_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.individualperformance.integratestrategicworkgroup.Window.superclass.constructor.call(this, cfg);
        this.observer();
    },

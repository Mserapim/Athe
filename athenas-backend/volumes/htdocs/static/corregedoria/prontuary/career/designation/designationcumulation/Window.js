Ext._define('corregedoria.prontuary.career.designation.designationcumulation.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.career.designation.designationcumulation.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.career.designation.designationcumulation.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function(cfg) {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detaildesignationcumulation: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detaildesignationcumulation_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.career.designation.designationcumulation.Window.superclass.constructor.call(this, cfg);
        this.observer(cfg);
    },

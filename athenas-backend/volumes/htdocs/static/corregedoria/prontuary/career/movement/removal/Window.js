Ext._define('corregedoria.prontuary.career.movement.removal.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.career.movement.removal.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.career.movement.removal.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function(cfg) {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detailremoval: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detailremoval_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.career.movement.removal.Window.superclass.constructor.call(this, cfg);
        this.observer(cfg);
    },

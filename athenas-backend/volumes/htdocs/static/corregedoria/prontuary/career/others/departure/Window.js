Ext._define('corregedoria.prontuary.career.others.departure.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.career.others.departure.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.career.others.departure.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function(cfg) {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detaildeparture: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detaildeparture_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.career.others.departure.Window.superclass.constructor.call(this, cfg);
        this.observer(cfg);
    },

Ext._define('corregedoria.prontuary.career.others.punishment.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.career.others.punishment.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.career.others.punishment.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function(cfg) {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detailpunishment: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detailpunishment_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.career.others.punishment.Window.superclass.constructor.call(this, cfg);
        this.observer(cfg);
    },

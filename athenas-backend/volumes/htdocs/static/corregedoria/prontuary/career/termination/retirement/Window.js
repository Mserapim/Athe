Ext._define('corregedoria.prontuary.career.termination.retirement.Window', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.prontuary.career.termination.retirement.Restful',

    width: 630,

    getAttachmentsGrid: function(cfg) {
        if(!this._attachmentsGrid) {
            this._attachmentsGrid = Ext._create('corregedoria.prontuary.career.termination.retirement.attachments.Grid', {
                region: 'center',
                layout: 'form',
                title: 'Anexos',
                border: true,
    ...
    observer: function(cfg) {
        if (this.oId) {
            ...
            this.getAttachmentsGrid().params = {detailretirement: this.oId,};
        } else {
            this.getAttachmentsGrid().disable();
        }
        this.getAttachmentsGrid().setFilterProperty('detailretirement_id', this.oId, 100);
    },
    ...
    constructor: function(cfg) {
        ...
        corregedoria.prontuary.career.termination.retirement.Window.superclass.constructor.call(this, cfg);
        this.observer(cfg);
    },

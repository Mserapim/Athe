Ext._define('corregedoria.inspection.inspection.WindowExecutionOrgan', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.inspection.inspection.Restful',
    width: 810,
    title: this.title + ' - Órgão de Execução',
        ...
        if(!this._formPanel) {
            this._formPanel = Ext._create('Ext.form.FormPanel', {
                ...
                items: [
                    ...
                    {
                        xtype:'fieldset',
                        title: '4. Dados da Procuradoria/Promotoria',
                        labelWidth: 115,
                        collapsible: false,
                        autoHeight:true,
                        width: 783,
    ...
    constructor: function(cfg) {
        ...
        corregedoria.inspection.inspection.WindowExecutionOrgan.superclass.constructor.call(this, cfg);
        this.observer(cfg);
    }
});

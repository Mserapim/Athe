Ext._define('corregedoria.inspection.inspection.WindowEspecialGroup', {
    extend: 'core.RestfulWindow',

    rest: 'corregedoria.inspection.inspection.Restful',
    width: 810,
    title: this.title + ' - Grupo Especial',
    ...
    constructor: function(cfg) {
        ...
        corregedoria.inspection.inspection.WindowEspecialGroup.superclass.constructor.call(this, cfg);
        this.observer(cfg);
    }
});

Ext._define('corregedoria.inspection.inspection.filling.regularityofservices.registrationpublicattendance.Restful', {
    extend: 'core.Restful',

    resource: 'INSPECTIONRegistrationPublicAttendance',

    getFields: function(cfg) {
        if(!this._fields)
            this._fields = corregedoria.inspection.inspection.filling.regularityofservices.registrationpublicattendance.Restful.superclass.getFields.call(this, cfg).concat([
                {type: "int", name: "year"},

Ext._define('corregedoria.inspection.inspection.filling.regularityofservices.registrationcourtlawsuitelectoralreturned.Restful', {
    extend: 'core.Restful',

    resource: 'INSPECTIONRegistrationCourtLawsuitElectoralReturned',

    getFields: function(cfg) {
        if(!this._fields)
            this._fields = corregedoria.inspection.inspection.filling.regularityofservices.registrationcourtlawsuitelectoralreturned.Restful.superclass.getFields.call(this, cfg).concat([
                {type: "int", name: "year"},

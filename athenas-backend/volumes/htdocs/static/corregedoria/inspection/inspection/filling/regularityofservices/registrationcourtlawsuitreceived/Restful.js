Ext._define('corregedoria.inspection.inspection.filling.regularityofservices.registrationcourtlawsuitreceived.Restful', {
    extend: 'core.Restful',

    resource: 'INSPECTIONRegistrationCourtLawsuitReceived',

    getFields: function(cfg) {
        if(!this._fields)
            this._fields = corregedoria.inspection.inspection.filling.regularityofservices.registrationcourtlawsuitreceived.Restful.superclass.getFields.call(this, cfg).concat([
                {type: "int", name: "year"},

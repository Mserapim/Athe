Ext._define('corregedoria.inspection.inspection.filling.functionalperformance.procforqualanalysisofthepartsoutcourtlawsuit.Restful', {
    extend: 'core.Restful',

    resource: 'INSPECTIONProcForQualAnalysisOfThePartsOutCourtLawsuit',

    getFields: function(cfg) {
        if(!this._fields)
            this._fields = corregedoria.inspection.inspection.filling.functionalperformance.procforqualanalysisofthepartsoutcourtlawsuit.Restful.superclass.getFields.call(this, cfg).concat([

Ext._define('corregedoria.inspection.inspection.filling.regularityofservices.registrationcourtlawsuitelectoralreceived.Restful', {
    extend: 'core.Restful',

    resource: 'INSPECTIONRegistrationCourtLawsuitElectoralReceived',

    getFields: function(cfg) {
        if(!this._fields)
            this._fields = corregedoria.inspection.inspection.filling.regularityofservices.registrationcourtlawsuitelectoralreceived.Restful.superclass.getFields.call(this, cfg).concat([
                {type: "int", name: "year"},

...
Ext._define('raf.management.DropEExt2AthenasWindow', {
    ...
    excluir: function() {
        ...
        var mask = new Ext.LoadMask(this.getEl(), {msg: 'Removendo Documentos do e-Ext(s)...'});
        if (values.validate) {
            mask.show();
            Ext.Ajax.request({
                scope: this,
                url: core.callAction('RAFFunctionalActivityReport', 'dropEExt2AthenasRAF'),
                callback: function() {
                    mask.hide();
                },
                success: function(request) {
                    ...
                    Ext.Msg.show({
                        title: 'Remover documento(s) do e-Ext',
                        msg: rst.message,
                        icon: Ext.Msg.INFO,
                        buttons: Ext.Msg.OK
                    });
    ...
    constructor: function(cfg) {
        ...
        raf.management.DropEExt2AthenasWindow.superclass.constructor.call(this, cfg);
    }
});

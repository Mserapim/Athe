 ...
 *
 **/
Ext._define('anotacao_pessoal.anotacao.servidor.Restful', {
    extend: 'core.Restful',

    resource: 'ServidorAnotacaoPessoalRF',

    getFields: function () {
        var fields = anotacao_pessoal.anotacao.servidor.Restful.superclass.getFields.call(this);

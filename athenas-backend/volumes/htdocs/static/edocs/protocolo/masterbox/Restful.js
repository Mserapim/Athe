...
Ext._define('edocs.protocolo.masterbox.Restful', {
    extend: 'core.Restful',

    resource: 'EDOCMasterBoxProtocolRestful',

    rendererDocument: function(pk, cbSuccess, cbFailure, cbCallback) {
        var emptyFailure = {
            fn: function(message) {
                Ext.Msg.show({
                    title: 'Buscando movimentações do protocolo',
                    msg: message,
                    icon: Ext.Msg.ERROR,
                    buttons: Ext.Msg.OK
                });
    ...
    getFields: function(cfg) {
        if(!this._fields)
            this._fields = edocs.protocolo.masterbox.Restful.superclass.getFields.call(this, cfg).concat([
                {
                    type: "int",
                    name: "midia",
                    useNull: true

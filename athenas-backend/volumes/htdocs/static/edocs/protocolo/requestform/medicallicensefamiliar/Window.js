Ext._define('edocs.protocolo.requestform.medicallicensefamiliar.Window', {
    extend: 'edocs.protocolo.box.ComposeWindow',

    mixins: { '1': 'edocs.protocolo.requestform.mixins.Common' },

    _resource: 'RFMedicalLicenseFamiliar',

    rest: 'edocs.protocolo.requestform.medicallicensefamiliar.Restful',

    width: 900,

    height: 450,

    getGradeFamiliarField: function (cfg) {
        if (!this._gradeFamiliarField) {
            this._gradeFamiliarField = Ext._create('Ext.form.TextField', {
                fieldLabel: "Parentesco familiar",
                name: "grade_familiar",
                width: 300,
                allowBlank: false
            });
        ...
        return this._gradeFamiliarField;
    },
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        this.getSubjectField(cfg, {
                            value: 'Requerimento Licença Junta Médica do Familiar',
                            readOnly: true,
                        }),
                ...
                },
                {
                    ...
                    layout: 'form',
                    labelWidth: 120,
                    items: this.getGradeFamiliarField(cfg)
                },
            ]
        });
...
edocs.protocolo.box.MainGrid.registerSpecialType({
    title: 'Requerimento Licença Junta Médica do Familiar',
    iconCls: '',
    restWindow: 'edocs.protocolo.requestform.medicallicensefamiliar.Window',
    specialType: 'medicallicensefamiliar',

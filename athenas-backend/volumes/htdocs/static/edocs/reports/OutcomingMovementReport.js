Ext._define('edocs.reports.OutcomingMovementReport', {
    ...
    panelTitle: 'Movimentações enviadas',

    reportPath: '/to/mpe/protocolo/movimentacoes_enviadas',

    reportName: 'EDOC - Movimentações enviadas',

    filename: 'edoc-relatorio-movimentacoes-enviadas',
    ...
    getOriginDepartmentField: function (cfg) {
        if (!this._originDepartmentField) {
            this._originDepartmentField = Ext._create('core.fields.ComboField', {
                fieldLabel: '<b>Local de origem</b>',
    ...
    getDestinationDepartmentField: function (cfg) {
        if (!this._destinationDepartmentField) {
            this._destinationDepartmentField = Ext._create('core.fields.AutocompleteField', {
                fieldLabel: 'Local de destino',
                rest: 'rh.workplace.Restful',
                allowBlank: true,
                emptyText: 'Informe o destino das movimentações (opcional)',
                preFilter: [
                    {
                        property: 'ativo',
                        value: true,
        ...
        if (!this._resetButton) {
            this._resetButton = Ext._create('Ext.Button', {
                ...
                handler: function() {
                    ...
                    this.getOriginDepartmentField().focus();
                },
                scope: this
            });
        }
    ...
    constructor: function (cfg) {
        ...
        edocs.reports.OutcomingMovementReport.superclass.constructor.call(this, cfg);
    }
});
